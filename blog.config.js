...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Joe的出海笔记', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '外贸从业者｜互联网工具爱好者｜实用主义者｜拒绝被割韭菜的探索者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://joenotes.co', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Joe的出海笔记,外贸教程,外贸工具分享,外贸客户开发,博客', // 网站关键词 英文逗号隔开
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-LH2SK1C5TL',
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一名外贸从业者, Hi，我是一名互联网工具爱好者,欢迎来到我的博客🎉',
